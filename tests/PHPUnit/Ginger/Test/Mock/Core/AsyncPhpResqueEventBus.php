...
use Ginger\Core\Cqrs\Bus\AsyncPhpResqueEventBus as RealAsyncPhpResqueEventBus;
/**
 *  AsyncPhpResqueEventBus
 * 
 * @author Alexander Miertsch <kontakt@codeliner.ws>
 */
class AsyncPhpResqueEventBus extends RealAsyncPhpResqueEventBus
{
    /**
